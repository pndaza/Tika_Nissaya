...
import mm.pndaza.tikanissaya.adapter.PageIndexNumberAdapter;
import mm.pndaza.tikanissaya.adapter.PageNumberAdapter;
...
public class PageSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        TikaBook paliBook = intent.getParcelableExtra("pali_book");
